 ...
 */
const generate2FASecretCallable = httpsCallable(functions, 'generate2FASecret');
const verify2FATokenCallable = httpsCallable(functions, 'verify2FAToken');
const disable2FACallable = httpsCallable(functions, 'disable2FA');
/**
