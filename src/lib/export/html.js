...
<body>
    <div class="page-header">
        ...
        <div class="page-metadata">
            <span><strong>Created:</strong> ${new Date(page.createdAt).toLocaleDateString("en-US", {
        year: "numeric",
        month: "long",
        day: "numeric",
    })}</span>
            <span><strong>Last Updated:</strong> ${new Date(page.updatedAt).toLocaleDateString("en-US", {
        year: "numeric",
        month: "long",
        day: "numeric",
    })}</span>
    ...
    <footer style="margin-top: 3rem; padding-top: 1rem; border-top: 1px solid #e9ecef; color: #999; font-size: 0.9rem; text-align: center;">
        <p>Exported from <strong>WorkLin</strong> on ${new Date().toLocaleDateString("en-US", {
        year: "numeric",
        month: "long",
        day: "numeric",
        hour: "2-digit",
 ...
 */
export function getHtmlContent(page) {
